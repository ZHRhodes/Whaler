...
public final class CreateTaskMutation: GraphQLMutation {
  ...
  public let operationDefinition: String =
    """
    mutation createTask($associatedTo: ID, $description: String!, $type: String, $dueDate: Time, $assignedTo: String) {
      createTask(
        input: {associatedTo: $associatedTo, description: $description, type: $type, dueDate: $dueDate, assignedTo: $assignedTo}
      ) {
        __typename
        id
        createdAt
  ...
  public init(associatedTo: GraphQLID? = nil, description: String, type: String? = nil, dueDate: String? = nil, assignedTo: String? = nil) {
  ...
  public var variables: GraphQLMap? {
    return ["associatedTo": associatedTo, "description": description, "type": type, "dueDate": dueDate, "assignedTo": assignedTo]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("createTask", arguments: ["input": ["associatedTo": GraphQLVariable("associatedTo"), "description": GraphQLVariable("description"), "type": GraphQLVariable("type"), "dueDate": GraphQLVariable("dueDate"), "assignedTo": GraphQLVariable("assignedTo")]], type: .nonNull(.object(CreateTask.selections))),
      ]
    }
...
public final class SaveTaskMutation: GraphQLMutation {
  ...
  public let operationDefinition: String =
    """
    mutation saveTask($id: ID!, $associatedTo: ID, $description: String!, $done: Boolean, $type: String, $dueDate: Time, $assignedTo: String) {
      saveTask(
        input: {id: $id, associatedTo: $associatedTo, description: $description, done: $done, type: $type, dueDate: $dueDate, assignedTo: $assignedTo}
      ) {
        __typename
        id
        createdAt
  ...
  public init(id: GraphQLID, associatedTo: GraphQLID? = nil, description: String, done: Bool? = nil, type: String? = nil, dueDate: String? = nil, assignedTo: String? = nil) {
    self.id = id
    self.associatedTo = associatedTo
    self.description = description
    self.done = done
  ...
  public var variables: GraphQLMap? {
    return ["id": id, "associatedTo": associatedTo, "description": description, "done": done, "type": type, "dueDate": dueDate, "assignedTo": assignedTo]
  }
